...
```
echo "PANTHER_REPO=$PANTHER_REPO"; echo "AI_RFC_WORKSPACE=$AI_RFC_WORKSPACE"; which arfc; ls …
ls /Users/elniak/ai-rfc-experiments/profile/projects/…
cat /Users/elniak/ai-rfc-experiments/profile/projects/…
```
